...
[功能特性](#-功能特性) · [社区版 vs Pro 版](#-社区版-vs-pro-版) · [Pro 迭代](#-pro-版--近期迭代) · [快速开始](#-快速开始) · [Pro 版获取](#-pro-版--赞助获取)
...
- **复制会话** —— 将 SSH 会话克隆为全新的独立标签页（独立 socket 与会话 ID）。复用已认证的连接，受 MFA 保护的主机不会再次要求输入 OTP。
- 终端**双击选词**。
- 终端**滚动缓冲区**、清除历史、等宽填充。
